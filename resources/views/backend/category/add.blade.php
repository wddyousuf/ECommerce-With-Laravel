              ...
              <div class="card">
                <div class="card-header">
                  <h3>
                      ...
                      Add Category
                      @endif
                    <a href="{{ route('category.view') }}" class="btn btn-info float-right "><i class="fa fa-list fa-xs ml-1 mr-1"></i>Manage Category</a>
                  </h3>
                  <div class="col-md-4">
                      @error('name')
                ...
                <div class="card-body">
                    <form action="{{ (@$editData)?route('category.update',$editData->id):route('category.store') }}" method="post" id="myForm" name="addcategory">
                        @csrf
                        <div class="form-row">
