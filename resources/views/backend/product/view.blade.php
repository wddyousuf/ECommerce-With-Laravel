              ...
              <div class="card">
                <div class="card-header">
                  <h3>
                    ...
                    Products
                    <a href="{{ route('product.add') }}" class="btn btn-info float-right "><i class="fa fa-plus-circle ml-1 mr-1"></i>Add Product</a>
                ...
                <div class="card-body">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach ($all_data as $key=>$product)
                        <tr class="{{ $product->id }}">
                            <td>{{ $key+1 }}</td>
                            ...
                            <td>{{ $product->stock }}</td>
                            <td><img src="{{ (!empty($product->image))? url('upload/product/'.$product->image): url('upload/noImage.jpg')}}"
